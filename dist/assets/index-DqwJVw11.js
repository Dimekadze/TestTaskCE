(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=class{constructor(e,t=`button`){this.text=e,this.type=t}render(e=null){return`
  ...
  `}var n=[{title:`Make Your business To Be Better Famous In Internet`,text:`Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`,iconUrl:`/src/assets/1.svg`,iconArrow:`/src/assets/Vector.svg`},{title:`Bring Technology To Your Comfrotable Home`,text:`Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`,iconUrl:`/src/assets/3.svg`,iconArrow:`/src/assets/Vector.svg`},{title:`Build Your Digital Product That Suitable For Your Need`,text:`Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`,iconUrl:`/src/assets/2 20.svg`,iconArrow:`/src/assets/Vector.svg`}],r=class{constructor(e,t,n,r){this.title=e,this.text=t,this.iconUrl=n,this.iconArrow=r}render(){return`
    ...
    `}};function i(){let e=new r(n[0].title,n[0].text,n[0].iconUrl,n[0].iconArrow),t=new r(n[1].title,n[1].text,n[1].iconUrl,n[1].iconArrow),i=new r(n[2].title,n[2].text,n[2].iconUrl,n[2].iconArrow);return`
    <main class="main">
  ...
  `}var a=new e(`SUBMIT`,`submit`),o=class{render(){return`
      <div class="forma">
        <div class="forma__window">
          ...
          <form id="contact_form" class="forma__form">
            ...
            <div class="forma--button">${a.render()}</div>
          </form>
        </div>
      </div>
    `}};function s(){let t=new e(`Let's Talk`),n=new o;return`
    <footer class="footer">
  ...
  `}function c(){let e=document.getElementById(`app`);e.innerHTML=`
    ...
    ${i()}
    ${s()}
  `;let n=document.getElementById(`modal`),r=document.getElementById(`open_modal`),a=document.getElementById(`close_modal`),o=document.getElementById(`contact_form`);r.addEventListener(`click`,()=>{n.showModal(),document.body.style.overflow=`hidden`}),a.addEventListener(`click`,()=>{n.close(),document.body.style.overflow=``}),o.addEventListener(`submit`,e=>{e.preventDefault();let t=!0,r=!0;[`name--error`,`email--error`,`message--error`].forEach(e=>{document.getElementById(e).style.display=`none`});let i=document.getElementById(`name`).value.trim(),a=document.getElementById(`email`).value.trim(),s=document.getElementById(`message`).value.trim();i||(document.getElementById(`name--error`).style.display=`block`,t=!1),a?/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(a)||(document.getElementById(`email--error`).style.display=`block`,document.getElementById(`email--error`).textContent=`Enter a correct email`,r=!1):(document.getElementById(`email--error`).style.display=`block`,t=!1),s||(document.getElementById(`message--error`).style.display=`block`,t=!1),t&&r&&(fetch(`https://httpbin.org/post`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({name:i,email:a,message:s})}),n.close(),document.body.style.overflow=``,o.reset())})}c();