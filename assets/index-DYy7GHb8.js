(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=class{constructor(e,t=`button`){this.text=e,this.type=t}render(e=null){return`
  ...
  `}var a=class{constructor(e,t,n,r){this.title=e,this.text=t,this.iconUrl=n,this.iconArrow=r}render(){return`
    ...
    `}},o=[{title:`Make Your business To Be Better Famous In Internet`,text:`Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`,iconUrl:`/man1.svg`,iconArrow:`/Vector.svg`},{title:`Bring Technology To Your Comfrotable Home`,text:`Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`,iconUrl:`/man2.svg`,iconArrow:`/Vector.svg`},{title:`Build Your Digital Product That Suitable For Your Need`,text:`Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`,iconUrl:`/female.svg`,iconArrow:`/Vector.svg`}];function s(){let e=new a(o[0].title,o[0].text,o[0].iconUrl,o[0].iconArrow),t=new a(o[1].title,o[1].text,o[1].iconUrl,o[1].iconArrow),n=new a(o[2].title,o[2].text,o[2].iconUrl,o[2].iconArrow);return`
    <main class="main">
