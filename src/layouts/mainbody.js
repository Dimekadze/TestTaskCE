...
export function main_body_render() {
  const card1 = new Card(
    cardsData[0].title, cardsData[0].text, cardsData[0].iconUrl, cardsData[0].iconArrow
  );

  const card2 = new Card(
    cardsData[1].title, cardsData[1].text, cardsData[1].iconUrl, cardsData[1].iconArrow
  );
  
  const card3 = new Card(
    cardsData[2].title, cardsData[2].text, cardsData[2].iconUrl, cardsData[2].iconArrow
  );
